...
stems4 <- stems3 |> 
  mutate(stem_GermanTranslation = if_else(stem_id == "9_1686458720",
         ...
         stem_GermanTranslation = replace(stem_GermanTranslation, stem_id == "15_1683517713", "von ... her (Ortsangabe); als (beim Komparativ)"),
         stem_crossref = replace(stem_crossref, stem_id == "15_1683517713", "§ 26a"),
         stem_crossref = replace(stem_crossref, stem_id == "15_1688050835", "132z10"),
         stem_crossref = if_else(stem_id == "11_1688358069",
                                 str_replace_all(stem_crossref, "\\)$", ""),
                                 stem_crossref),
         stem_crossref = if_else(stem_id == "10_1685910505",
                                 str_replace_all(stem_crossref, "\\(|\\)", ""),
                                 stem_crossref),
         stem_crossref = if_else(stem_id == "8_1685086967",
                                 str_replace_all(stem_crossref, "\\s+", " "),
                                 stem_crossref),
         stem_crossref = if_else(stem_id %in% c("10_1687836396", "10_1688901110"),
                                 str_replace_all(stem_crossref, "P1", "Pl"),
                                 stem_crossref),
         stem_remark = if_else(stem_id == "11_1683690932",
                               str_replace_all(stem_remark, "ū", "ü"),
                               stem_remark),
         stem_crossref = replace(stem_crossref, stem_id == "10_1689604258", "für die Zukunft, § 29d"),
         stem_crossref = replace(stem_crossref, stem_id == "10_1685075644", "Hilfszählwort, nicht in § 34b genannt"),
         ...
         stem_crossref = replace(stem_crossref, stem_id == "12_1684833641", "108z27"),
         stem_crossref = replace(stem_crossref, stem_id == "11_1685075099", "109z9"),
         stem_crossref = replace(stem_crossref, stem_id == "10_1683777480", "Heyne 53/1862 koro-koro 'Piper nigrum'"),
         stem_crossref = replace(stem_crossref, stem_id == "11_1684820930", "130z2"),
         stem_crossref = replace(stem_crossref, stem_id == "8_1684471928", "107z26; 3.Pl, vorangestelltes Possessivpronomen, § 14b"),
         stem_crossref = replace(stem_crossref, stem_id == "17_1686378964", "VIz1"),
         stem_crossref = replace(stem_crossref, stem_id == "11_1684289876", "IXz24ff: Manche trugen auch einen Fingerring, der aus ekada-Muschelschalen geschliffen wurde, am kleinen Finger, evtl. noch einen zweiten am Ringfinger der linken Hand."),
         ...
         stem_crossref = replace(stem_crossref, stem_id == "12_1685932804", "beim Vgl; 106,16: kidee"),
         ...
         stem_remark = if_else(stem_id == '19_1683781496',
                               ...
                               stem_remark),
         stem_remark = replace(stem_remark, stem_id == "17_1683989044", "Sim kun bəlint'i[X]"),
