...
Repository containing the R codes and the associated materials to process the retro-digitisation[^1] output of the Enggano-German Dictionary [@kähler1987]. My work in the digitasation task is substantially supported by the core members of the digitisation team:
