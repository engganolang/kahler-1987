...
Please cite the source of the data set ([Kähler 1987](#ref-kähler1987))
(if in APA7<sup>th</sup>) and the particular version of this repository
([Rajeg et al. 2024](#ref-rajeg_kahler)) (in
...
[Releases](https://github.com/engganolang/kahler-1987/releases) page on
